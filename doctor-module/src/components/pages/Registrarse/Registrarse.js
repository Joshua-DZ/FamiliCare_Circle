...
export default function Registrarse() {
  const [formData, setFormData] = useState({
    ...
    telefono: "",
    contraseña: "",
    horarioConsulta: "Lunes a Viernes 8:00 - 16:00", // Campo que faltaba
    estado: "Activo"
  });
...
const response = await fetch('http://localhost:3001/api/registrarse', {
 ...
 body: JSON.stringify({
  ...
  horarioConsulta: formData.horarioConsulta  // ← 'horarioConsulta' no 'Horario_Consulta'
    ...
    <div className="login-page">
      ...
      <div className="login-card">
        ...
        <div className="login-hint">
          ...
          <p>El ID se generará automáticamente</p>
        </div>
